<template>
    <div>
        <BreadcrumbComponent main-page="Enquiries" current-page="Demo Session" />
                ...
                <div class="col-12">
                    <div class="box">
                        <div class="box-header d-flex justify-content-between align-items-center">
                            <h4 class="box-title">Demo Session</h4>
                        </div>
                        <div class="box-body">
...
export default {
    ...
    methods: {
        async getTableData(page=0) {
            ...
            try {
                const response = await this.$privateApi.get('/demo-session/paginate?skip='+page); // eslint-disable-line
