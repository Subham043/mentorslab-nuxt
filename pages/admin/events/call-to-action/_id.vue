<template>
    <div>
        <BreadcrumbComponent main-page="Call To Action" current-page="Edit" />
        <section class="content">
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Edit Call To Action</h4>
                        </div>
                        <!-- /.box-header -->
                        <ValidationObserver ref="form" v-slot="{ handleSubmit }">
                        <form class="form" method="post" @submit.prevent="handleSubmit(formHandler)">
                            <div class="box-body">
                                <h4 class="box-title text-primary mb-0"><i class="el-icon-reading"></i> Call To Action Info</h4>
                                <hr class="my-15">
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <el-input v-model="description" style="width: 100%;" type="textarea" :rows="4" placeholder="Enter Description"></el-input>
                                        </div>
                                        <span :class="classes">{{ errors[0] }}</span>
                                        </ValidationProvider>
                                    </div>
...
export default {
    ...
    methods: {
        async formHandler() {
            ...
            try {
                const response = await this.$privateApi.post('/event-call-to-action/'+this.$route.params.id, {heading: this.heading, description: this.description}); // eslint-disable-line
                this.$toast.success('Call to action updated successfully')
        ...
        async getData(){
            ...
            try {
                const response = await this.$privateApi.get('/event-call-to-action/'+this.$route.params.id); // eslint-disable-line
                // eslint-disable-next-line no-console
