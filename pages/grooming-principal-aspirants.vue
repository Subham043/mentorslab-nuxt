<template>
  <div>
            ...
            <div class="row justify-content-between">
              <div class="col-lg-4 col-md-6 col-sm-12 text-center">
                  <div class="icon_col">
                    ...
                    <h4>Grooming to next-level leadership roles from Experts</h4>
                  </div>
              </div>
              <div class="col-lg-4 col-md-6 col-sm-12 text-center">
                  <div class="icon_col">
                    ...
                    <h4>Access to Digital Knowledge Repository</h4>
                  </div>
              </div>
              <div class="col-lg-4 col-md-6 col-sm-12 text-center">
                  <div class="icon_col">
                    ...
                    <h4>Free Assessment for Teacher Educators</h4>
                  </div>
              </div>
              <div class="col-lg-4 col-md-6 col-sm-12 text-center">
                  <div class="icon_col">
                    ...
                    <h4>Career Shift opportunities in Leadership roles</h4>
                  </div>
              </div>
              <div class="col-lg-4 col-md-6 col-sm-12 text-center">
                  <div class="icon_col">
                    ...
                    <h4>Access to Leadership Programs</h4>
                  </div>
              </div>
              <div class="col-lg-4 col-md-6 col-sm-12 text-center">
                  <div class="icon_col">
                    ...
                    <h4>Personalized Mentoring and Coaching</h4>
                  </div>
              </div>
              <div class="col-lg-4 col-md-6 col-sm-12 text-center">
                  <div class="icon_col">
              ...
              <div class="col-lg-4 col-md-6 col-sm-12 text-center">
                  <div class="icon_col">
                    ...
                    <h4>Coaching on Administration Skills</h4>
                  </div>
              </div>
              <div class="col-lg-4 col-md-6 col-sm-12 text-center">
                  <div class="icon_col">
                    ...
                    <h4>Assessment and Certification from Edumentorslab</h4>
                  </div>
              </div>
            </div>
          </div>
    ...
    <!-- Certificate Start -->
    <div
      class="section certificate-section certificate-section-school-leader  testimonial-section section-padding pt-2 pb-2 mb-5">
      <div class="container">
        <!-- Certificate Wrapper Start -->
        <div class="certificate-wrapper">
          <!-- Section Title Start -->
        ...
        <div class="testimonial-wrapper swiper-container testimonial-active">
          <div class="swiper-wrapper">
            <VueSlickCarousel v-bind="slickOptions" ref="slickTestimonial">
              <FrontendTestimonialCardComponent image="/images/avatar.png" title="Priya Roshan"
              ...
              <FrontendTestimonialCardComponent image="/images/avatar.png" title="Bhuvaneshwari Vishwanathan"
              ...
              <FrontendTestimonialCardComponent image="/images/avatar.png" title="Neethu Reddy" designation="ITTC Batch"
              ...
              <FrontendTestimonialCardComponent image="/images/avatar.png" title="Neha Agarwal" designation="ITTC Batch"
...
Varada Murthy Sir.. Sir you are doing a superb job for upcoming generation and young Indians, we teachers and children." />
              <FrontendTestimonialCardComponent image="/images/avatar.png" title="Priya Roshan" designation="ITTC Batch"
                message='Glad to connect with you again with this mail. It gives me immense happiness in sharing this news with you all.  In my first year of teaching career, i have been awarded with "The Best Teacher Award for the year 2014-2015" by my school-New Beginnings Pre-school for Excellence. I want to thank you all for making this happen to me. Without your guidance and training, this would not have been possible. Your training has really helped me getting this award. Special thanks to Shuba mam and Nalina Mam.' />
              <FrontendTestimonialCardComponent image="/images/avatar.png" title="Pradeepa" designation="ITTC BTM Batch"
              ...
              <div class="col-md-12 mb-2">
                <ValidationProvider v-slot="{ classes, errors }" rules="required" name="message">
                  <div class="form-group">
                    ...
                    <el-input v-model="message" type="textarea" :row="10" style="width: 100%;"
                      placeholder="Enter Message"></el-input>
                  </div>
                  <span :class="classes">{{ errors[0] }}</span>
                </ValidationProvider>
              </div>
