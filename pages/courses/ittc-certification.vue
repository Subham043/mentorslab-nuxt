  ...
  <div>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-sm-12">
            ...
            <p>Our purpose is to help people unleash their true potential through life transforming
              ...
              and Life. Edumentorslab (formerly PFLA) is an Award Winning (Future of India Award for Business
    ...
    <div class="detail">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 220">
        <path fill="#dde8fa" fill-opacity="1"
          d="M0,128L80,106.7C160,85,320,43,480,58.7C640,75,800,149,960,160C1120,171,1280,117,1360,90.7L1440,64L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z">
        </path>
      </svg>
    </div>
    ...
    <div class="py-5 detail mb-5">
      <div class="container">
        <div class="row justify-content-center">
          ...
          <div class="col-md-6 col-sm-12">
            <iframe src="https://www.youtube-nocookie.com/embed/8e0AZzr779E" class="w-100" height="400"
              frameborder="0"></iframe>
          </div>
        </div>
      </div>
