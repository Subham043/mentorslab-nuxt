<template>
    <div>
        <BreadcrumbComponent main-page="Live Session Content" current-page="Edit" />
        <section class="content">
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Edit Live Session Content</h4>
                        </div>
                        <!-- /.box-header -->
...
export default {
    name: "EditLiveSessionContentPage",
    ...
    methods: {
        ...
        async checkId(){
            ...
            if(!this.$route.params.id){
                ...
                this.$router.push('/admin/live-session-content/list');
            }
            try {
                const response = await this.$privateApi.get('/live-session-content/'+this.$route.params.id); // eslint-disable-line
