                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <el-table :data="tableData" style="width: 100%" max-height="100%">
                                ...
                                <el-table-column prop="forContentAssigned.assignedContent.name" label="Content Name" width="250">
                                </el-table-column>
                                <el-table-column prop="forContentAssigned.assignedContent.heading" label="Content Heading" width="250">
                                </el-table-column>
...
export default {
    ...
    methods: {
        async getTableData(page=0) {
            ...
            try {
                const response = await this.$privateApi.get('/payment/content-paginate?skip='+page); // eslint-disable-line
