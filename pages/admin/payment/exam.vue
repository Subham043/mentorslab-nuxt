<template>
    <div>
        <BreadcrumbComponent main-page="Payment" current-page="Exam" />
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <el-table :data="tableData" style="width: 100%" max-height="100%">
                                ...
                                <el-table-column prop="forExamAssigned.exam.name" label="Exam Name" width="250">
                                </el-table-column>
                                <el-table-column prop="forExamAssigned.exam.heading" label="Exam Heading" width="250">
                                </el-table-column>
...
export default {
    ...
    methods: {
        async getTableData(page=0) {
            ...
            try {
                const response = await this.$privateApi.get('/payment/exam-paginate?skip='+page); // eslint-disable-line
