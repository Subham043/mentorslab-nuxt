<template>
    ...
    <div class="card d-block bg-holder-img  ribbon-box">
        <div class="card-body">
            <img class="card-img-top" :src="`${apiUrl}/exam-user/image/${uuid}`" alt="Card image cap">
            ...
            <NuxtLink :to="`/exam/detail/${uuid}`" class="btn btn-primary-light">
                <span v-if="paid && !purchased"> Pay Now @ Rs. {{amount}} & Start Exam</span>
