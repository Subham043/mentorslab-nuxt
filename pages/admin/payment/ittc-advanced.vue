<template>
    <div>
        <BreadcrumbComponent main-page="Payment" current-page="Content" />
                ...
                <div class="col-12">
                    <div class="box">
                        <div class="box-header d-flex justify-content-between align-items-center">
                            <h4 class="box-title">ITTC Advanced</h4>
                        </div>
                        <div class="box-body">
...
export default {
    name: "PaymentIttcAdvancedListPage",
    ...
    methods: {
        async getTableData(page=0) {
            ...
            try {
                const response = await this.$privateApi.get('/ittc-advanced/registration?skip='+page); // eslint-disable-line
