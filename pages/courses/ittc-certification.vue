        ...
        <div class="container">
          <div class="row">
            <div class="col-md-7 col-sm-12">
              ...
              <NuxtLink to="/auth/login" class="btn">Apply Now</NuxtLink>
            </div>
...
community</p>
            ...
            <NuxtLink to="/auth/login" class="btn">Explore More</NuxtLink>
            </div>
            <div class="col-md-6 col-sm-12">
              <iframe src="https://www.youtube-nocookie.com/embed/OOfYqSCvZy8" class="w-100 h-100" frameborder="0"></iframe>
            </div>
