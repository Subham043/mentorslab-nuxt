    ...
    methods: {
        async formHandler() {
            ...
            try {
                ...
                const response = await this.$privateApi.post('/category/'+this.$route.params.assessment_id, formData); // eslint-disable-line
                this.$toast.success('Assessment Category created successfully')
