<template>
  <div class="bg-white rounded10 shadow-lg">
    <div class="content-top-agile p-20 pb-0">
      ...
      <p class="mb-0 text-fade">Sign in to continue to Edumentorslab.</p>
    </div>
    <div class="p-40">
        ...
        <form method="post" @submit.prevent="handleSubmit(formHandler)">
          <div class="form-group">
            <ValidationProvider v-slot="{ classes, errors }" rules="required|email" name="email">
              <div class="input-group mb-3">
                <span class="input-group-text bg-transparent"><i class="el-icon-message"></i></span>
                <input v-model="email" type="email" class="form-control ps-15 bg-transparent" placeholder="Email" />
              </div>
          ...
          <div class="form-group">
            <ValidationProvider v-slot="{ classes, errors }" rules="required" name="password">
              <div class="input-group mb-3">
                <span class="input-group-text bg-transparent"><i class="el-icon-lock"></i></span>
                <input v-model="password" type="password" class="form-control ps-15 bg-transparent"
          ...
          <div class="row">
            ...
            <div class="col-6">
              <div class="fog-pwd text-end">
                <NuxtLink to="/auth/forgot-password" class="text-primary fw-500 hover-primary"><i
                    class="ion ion-locked"></i> Forgot password?</NuxtLink><br />
              </div>
            </div>
            <!-- /.col -->
      ...
      <div class="text-center">
        <p class="mt-15 mb-0 text-fade">
          ...
          <!-- <NuxtLink to="/grooming-principal-aspirants" class="text-primary ms-5">Register</NuxtLink> -->
        </p>
      </div>
