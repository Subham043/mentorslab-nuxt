                ...
                <div class="col-12">
                    <div class="box">
                        <div class="box-header d-flex justify-content-between align-items-center">
                            ...
                            <NuxtLink :to="`/admin/assessment/${$route.params.assessment_id}/question-answer/create`"><el-button type="warning">Create</el-button></NuxtLink>
                        </div>
                        <div class="box-body">
                            <el-table :data="tableData" style="width: 100%" max-height="100%">
                                <el-table-column fixed prop="id" label="ID" width="150">
                                </el-table-column>
                                <el-table-column label="Question" width="850">
                                ...
                                <el-table-column fixed="right" label="Operations" width="150">
                                    <template slot-scope="scope">
                                        <NuxtLink :to="`/admin/assessment/${$route.params.assessment_id}/question-answer/edit/${scope.row.id}`"><el-button type="primary" icon="el-icon-edit" circle></el-button></NuxtLink>
                                        <el-popconfirm
...
export default {
    ...
    methods: {
        async getTableData(page=0) {
            ...
            try {
                const response = await this.$privateApi.get('/assessment-question-answer/paginate/'+this.$route.params.assessment_id+'?skip='+page); // eslint-disable-line
