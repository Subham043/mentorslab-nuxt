<template>
    <div>
        <BreadcrumbComponent main-page="Assessment" current-page="Edit" />
        <section class="content">
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Edit Assessment</h4>
                        </div>
                        <!-- /.box-header -->
                        <ValidationObserver ref="form" v-slot="{ handleSubmit }">
                            <form class="form" method="post" @submit.prevent="handleSubmit(formHandler)">
                            <div class="box-body">
                                <h4 class="box-title text-primary mb-0"><i class="el-icon-reading"></i> Assessment Info</h4>
                                <hr class="my-15">
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <h4 class="box-title text-primary mb-0 mt-20"><i class="el-icon-lock"></i> Assessment Security
                                </h4>
                                <hr class="my-15">
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <h4 v-if="paid" class="box-title text-primary mb-0 mt-20"><i class="el-icon-price-tag"></i> Assessment Price
                                </h4>
                            ...
                            <div class="box-footer">
                                <NuxtLink to="/admin/assessment/list"><button type="button" class="btn btn-primary-light me-1">
    ...
    methods: {
        async formHandler() {
            ...
            try {
                ...
                const response = await this.$privateApi.put('/assessment/'+this.$route.params.id, formData); // eslint-disable-line
        ...
        async checkId(){
            ...
            if(!this.$route.params.id){
                ...
                this.$router.push('/admin/assessment/list');
            }
            try {
                const response = await this.$privateApi.get('/assessment/'+this.$route.params.id); // eslint-disable-line
