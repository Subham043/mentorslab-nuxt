...
<template>
  <div class="p-30 bg-white">
    <div class="d-flex align-items-center justify-content-between pb-30">
      <h4 class="m-0">
        User Profile <small class="text-fade fs-12 ms-5">12 messages</small>
      </h4>
      <a
        href="#"
      ...
      <div class="d-flex flex-row">
        ...
        <div class="ps-20">
          ...
          <a href="mailto:dummy@gmail.com"
            ...
            dummy@gmail.com</a
          >
          <button class="btn btn-success-light btn-sm mt-5">
            <i class="ti-plus"></i> Follow
          </button>
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <div class="d-flex align-items-center mb-30">
        ...
        <div class="d-flex flex-column fw-500">
          <a href="mailbox.html" class="text-dark hover-danger mb-1 fs-16"
            >My Messages</a
          >
      ...
      <div class="d-flex align-items-center mb-30">
        ...
        <div class="d-flex flex-column fw-500">
          <a href="extra_taskboard.html" class="text-dark hover-info mb-1 fs-16"
            >Project</a
          >
