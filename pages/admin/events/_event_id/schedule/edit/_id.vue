<template>
    <div>
        <BreadcrumbComponent main-page="Event Schedule" current-page="Edit" />
        <section class="content">
            <div class="row">
                <div class="col-lg-12 col-12">
                    <div class="box">
                        <div class="box-header with-border">
                            <h4 class="box-title">Edit Event Schedule</h4>
                        </div>
                        <!-- /.box-header -->
    ...
    methods: {
        async formHandler() {
            ...
            try {
                ...
                const response = await this.$privateApi.put('/event-schedule/'+this.$route.params.id, formData); // eslint-disable-line
                this.$toast.success('Event Schedule updated successfully')
        ...
        async checkId(){
            ...
            if(!this.$route.params.id){
                ...
                this.$router.push(`/admin/events/${this.$route.params.event_id}/schedule/list`);
            }
            try {
                const response = await this.$privateApi.get('/event-schedule/display/'+this.$route.params.id); // eslint-disable-line
